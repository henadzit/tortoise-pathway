...
async def test_model_changes(setup_test_db):
    ...
    assert operations[5].index.fields == ["created_at"]
    assert operations[5].index_name == "idx_blogs_created_5b8c34"
    ...
    assert operations[9].fields == ["blog_id", "name"]
    assert operations[9].index_name == "uniq_tags_blog_id_737495"
